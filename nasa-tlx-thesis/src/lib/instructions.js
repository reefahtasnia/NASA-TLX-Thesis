// EXACT COPY from old/src/assets/instructions.js
export default {
  ratingSheet: [
    ...
    going to describe the technique that will be used to examine your experiences.
    In the most general sense we are examining the "workload" you
    ...
    workload may come from the task itself, your feelings about your own performance,
    ...
    person, there are no effective "rulers" that can be used to estimate the workload
    of different activities. One way to find out about workload is to ask
    ...
    Note that 'performance" goes from "Poor" on the left to "Good" on the
    ...
    you are satisfied, press either button to enter your selection. Please consider
    your responses carefully in distinguishing among the task conditions,
  ...
  compareCard: [
    ...
    them in individual ways For example, some people feel that mental or temporal
    demands are the essential aspects of workload regardless of the effort
    they expended or the performance they achieved. Others feel that if they
    performed well the workload must have been low and vice versa. Yet others
    feel that effort or feelings of frustration are the most important factors
    in workload: and so on. The results of previous studies have already found
    every conceivable pattern of values. In addition, the factors that create levels
    of workload differ depending on the task, For example, some tasks
    might be difficult because they must be completed very quickly. Others may
    seem easy or hard because of the intensity of mental or physical effort
    ...
    developed by NASA to assess the relative importance of six factors in determining
    how much workload you experienced. The procedure is simple: You
    ...
    performed. Each pair of scale titles will appear separateTy on the screen.
    ...
    your first choice, and then start over.`,
    `After you have finished the entire series we will be able to use the pattern
    of your choices to create a weighted combination of the ratings from
    that task into a summary workload score Please consider your choices carefully
    and make them consistent with how you used the rating scales during
